...
<div class="container container-anunciante">
	...
	<div class="col-md-8 col-xs-12">
			...
			<form method="POST" action="{{ route('anunciante.store', 'imobiliaria') }}" id="anunciantes">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                    	 ...
                    	 <label for="nome" class="col-form-label text-md-right">{{ __('Nome da imobiliária') }}</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                    	 ...
                    	 <label for="contato" class="col-form-label text-md-right">{{ __('Contato') }}</label>
                    ...
                    <div class="col-md-4">
                    	<label for="cargo" class="col-form-label text-md-right">{{ __('Cargo') }}</label>
                ...
                <div class="form-group row">
                	 ...
                	 <div class="col-md-12">
                	 	...
                	 	<textarea rows="4" class="form-control{{ $errors->has('sobre') ? ' is-invalid' : '' }} char-count" name="sobre" id="sobre" maxlength="200"> {{ old('sobre') }}</textarea>
